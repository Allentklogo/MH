...
public class JoinRoomServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3307113234412525212L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MessageInboundRoom room = MessageInboundRoomPool.findRoomByName(roomName);
		if( room != null ){
			room.addClientMessageInbound(
					ClientMessageInboundPool.getOnLineClient(user)
					);
		}
	}
